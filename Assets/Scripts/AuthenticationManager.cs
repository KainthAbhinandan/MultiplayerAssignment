...
public class AuthenticationManager : MonoBehaviour
{
   ...
   const string IdentityPool = "ap-south-1:833ccbe9-e1a5-42fe-9cfc-f00c49cf1e8a"; //insert your Cognito User Pool ID, found under General Settings
   const string AppClientID = "5olhj4b8jufbf38unu4c5co8hm"; //insert App client ID, found under App Client Settings
